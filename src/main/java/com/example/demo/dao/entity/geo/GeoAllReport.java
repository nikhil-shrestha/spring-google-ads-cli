...
@Entity(name = "GeoAll")
@Table(name = "geo_all")
public class GeoAllReport implements Serializable {
  @Id
  @SequenceGenerator(
    name = "geo_sequence",
  ...
  public void setAdUnitName(String adUnitName) {
    ...
    System.out.println("adUnitName = " + adUnitName);
  }
  ...
  public void setAdUnitId(String adUnitId) {
    try {
      ...
      System.out.println("adUnitId = " + adUnitId);
  ...
  public void setTotalUnfilledImpressions(String totalUnfilledImpressions) {
    try {
      ...
      System.out.println("totalUnfilledImpressions = " + totalUnfilledImpressions);
    } catch (NumberFormatException e) {
      System.out.println(e.getMessage());
    }
  }
  ...
  public void setTotalItemClicks(String totalItemClicks) {
    try {
      ...
      System.out.println("totalItemClicks = " + totalItemClicks);
    } catch (NumberFormatException e) {
      System.out.println(e.getMessage());
    }
  }
  ...
  public void setTotalAdRequest(String totalAdRequest) {
    try {
      ...
      System.out.println("totalAdRequest = " + totalAdRequest);
    } catch (NumberFormatException e) {
      System.out.println(e.getMessage());
    }
  }
  ...
  public void setTotalResponseServed(String totalResponseServed) {
    try {
      ...
      System.out.println("totalResponseServed = " + totalResponseServed);
    } catch (NumberFormatException e) {
      System.out.println(e.getMessage());
    }
  }
  ...
  public void setCountryCriteriaID(String countryCriteriaID) {
    try {
      ...
      System.out.println("countryCriteriaID = " + countryCriteriaID);
    } catch (NumberFormatException e) {
      System.out.println(e.getMessage());
    }
  }
